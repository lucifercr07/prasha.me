...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap font-spartan">
        ...
        <form
          ...
          <p className="leading-relaxed mb-5">
            I'm Prashant Shubham, a passionate software engineer with expertise in distributed systems, 
            data engineering, and databases. Always eager to learn and take on new challenges, 
            and I love to solve complex problems. If you are looking for a driven and skilled professional to join your team, 
            I would love to hear from you. Let's create something amazing together!
          </p>
